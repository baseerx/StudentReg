...
@%:@ Generated by GNU Autoconf 2.63 for mozjpeg 3.2.
@%:@ 
...
{ $as_echo "$as_me:$LINENO: checking whether compiler supports pointers to undefined structures" >&5
...
if $PKG_CONFIG --atleast-pkgconfig-version 0.20; then
        ...
        if test $_pkg_short_errors_supported = yes; then
	        libpng_PKG_ERRORS=`$PKG_CONFIG --short-errors --print-errors "libpng12" 2>&1`
        else 
	        libpng_PKG_ERRORS=`$PKG_CONFIG --print-errors "libpng12" 2>&1`
        fi
	# Put the nasty error message in config.log where it belongs
	echo "$libpng_PKG_ERRORS" >&5
...
{ $as_echo "$as_me:$LINENO: result: $ac_cv_type_unsigned_char" >&5
$as_echo "$ac_cv_type_unsigned_char" >&6; }
...
{ $as_echo "$as_me:$LINENO: checking for unsigned short" >&5
$as_echo_n "checking for unsigned short... " >&6; }
...
{ $as_echo "$as_me:$LINENO: result: $ac_cv_type_unsigned_short" >&5
$as_echo "$ac_cv_type_unsigned_short" >&6; }
...
{ $as_echo "$as_me:$LINENO: checking if right shift is signed" >&5
$as_echo_n "checking if right shift is signed... " >&6; }
if test "$cross_compiling" = yes; then
  { $as_echo "$as_me:$LINENO: result: Assuming that right shift is signed on target machine." >&5
...
{ $as_echo "$as_me:$LINENO: checking libjpeg API version" >&5
...
{ $as_echo "$as_me:$LINENO: result: $JPEG_LIB_VERSION_DECIMAL" >&5
...
MEM_SRCDST_FUNCTIONS=
if test "x${with_jpeg8}" != "xyes"; then
  { $as_echo "$as_me:$LINENO: checking whether to include in-memory source/destination managers" >&5
...
{ $as_echo "$as_me:$LINENO: checking libjpeg shared library version" >&5
$as_echo_n "checking libjpeg shared library version... " >&6; }
{ $as_echo "$as_me:$LINENO: result: $SO_MAJOR_VERSION.$SO_AGE.$SO_MINOR_VERSION" >&5
...
VERSION_MAJOR=m4_argn(1,3, 2)
VERSION_MINOR=m4_argn(2,3, 2)
VERSION_REVISION=m4_argn(3,3, 2)
...
{ $as_echo "$as_me:$LINENO: checking whether the linker supports version scripts" >&5
...
$as_echo "$ac_try_echo") >&5
  ...
  VERSION_SCRIPT_FLAG=-Wl,--version-script,;
   { $as_echo "$as_me:$LINENO: result: yes (GNU style)" >&5
...
$as_echo "$ac_try_echo") >&5
  ...
  VERSION_SCRIPT_FLAG=-Wl,-M,;
     { $as_echo "$as_me:$LINENO: result: yes (Sun style)" >&5
...
{ $as_echo "$as_me:$LINENO: checking whether to use version script when building mozjpeg" >&5
$as_echo_n "checking whether to use version script when building mozjpeg... " >&6; }
{ $as_echo "$as_me:$LINENO: result: $VERSION_SCRIPT" >&5
...
rm -f core conftest.err conftest.$ac_objext conftest.$ac_ext
{ $as_echo "$as_me:$LINENO: result: $ljt_cv_inline" >&5
...
{ $as_echo "$as_me:$LINENO: checking whether to include arithmetic encoding support" >&5
...
{ $as_echo "$as_me:$LINENO: checking whether to include arithmetic decoding support" >&5
...
{ $as_echo "$as_me:$LINENO: checking whether to use 12-bit samples" >&5
...
# TurboJPEG support
{ $as_echo "$as_me:$LINENO: checking whether to build TurboJPEG C wrapper" >&5
...
{ $as_echo "$as_me:$LINENO: checking whether to build TurboJPEG Java wrapper" >&5
...
_ACEOF
 DUMMY=1
  ...
  { { $as_echo "$as_me:$LINENO: error: Could not find JNI header file" >&5
$as_echo "$as_me: error: Could not find JNI header file" >&2;}
   { (exit 1); exit 1; }; }
fi
...
if test "x${with_simd}" != "xno"; then
  ...
  { $as_echo "$as_me:$LINENO: checking if we have SIMD optimisations for cpu type" >&5
$as_echo_n "checking if we have SIMD optimisations for cpu type... " >&6; }
  case "$host_cpu" in
    x86_64 | amd64)
      { $as_echo "$as_me:$LINENO: result: yes (x86_64)" >&5
...
$as_echo "no" >&6; }
  ...
  test -z "$NASM" && { { $as_echo "$as_me:$LINENO: error: no nasm (Netwide Assembler) found" >&5
$as_echo "$as_me: error: no nasm (Netwide Assembler) found" >&2;}
   { (exit 1); exit 1; }; }
fi

{ $as_echo "$as_me:$LINENO: checking for object file format of host system" >&5
...
{ $as_echo "$as_me:$LINENO: result: $objfmt" >&5
$as_echo "$objfmt" >&6; }
if test "$objfmt" = 'ELF ?'; then
  objfmt='ELF'
  { $as_echo "$as_me:$LINENO: WARNING: unexpected host system. assumed that the format is $objfmt." >&5
$as_echo "$as_me: WARNING: unexpected host system. assumed that the format is $objfmt." >&2;}
fi

{ $as_echo "$as_me:$LINENO: checking for object file format specifier (NAFLAGS) " >&5
...
{ $as_echo "$as_me:$LINENO: result: $NAFLAGS" >&5
$as_echo "$NAFLAGS" >&6; }


{ $as_echo "$as_me:$LINENO: checking whether the assembler ($NASM $NAFLAGS) works" >&5
...
$as_echo "yes" >&6; }
  ...
  { $as_echo "$as_me:$LINENO: result: no" >&5
$as_echo "no" >&6; }
  { { $as_echo "$as_me:$LINENO: error: installation or configuration problem: assembler cannot create object files." >&5
$as_echo "$as_me: error: installation or configuration problem: assembler cannot create object files." >&2;}
   { (exit 1); exit 1; }; }
fi

{ $as_echo "$as_me:$LINENO: checking whether the linker accepts assembler output" >&5
...
$as_echo "yes" >&6; }
  ...
  { $as_echo "$as_me:$LINENO: result: no" >&5
$as_echo "no" >&6; }
  { { $as_echo "$as_me:$LINENO: error: configuration problem: maybe object file format mismatch." >&5
$as_echo "$as_me: error: configuration problem: maybe object file format mismatch." >&2;}
   { (exit 1); exit 1; }; }
fi
      ...
      ;;
    i*86 | x86 | ia32)
      { $as_echo "$as_me:$LINENO: result: yes (i386)" >&5
$as_echo "yes (i386)" >&6; }
...
$as_echo "$as_me: error: configuration problem: maybe object file format mismatch." >&2;}
   { (exit 1); exit 1; }; }
      ...
      ;;
    arm*)
      { $as_echo "$as_me:$LINENO: result: yes (arm)" >&5
$as_echo "yes (arm)" >&6; }
      { $as_echo "$as_me:$LINENO: checking if the assembler is GNU-compatible and can be used" >&5
...
rm -f core conftest.err conftest.$ac_objext conftest.$ac_ext
  ...
  if test "x$ac_good_gnu_arm_assembler" = "xyes" ; then
    if test "x$ac_use_gas_preprocessor" = "xyes"; then
           { $as_echo "$as_me:$LINENO: result: yes (with gas-preprocessor)" >&5
...
$as_echo "no" >&6; }
      ...
      if test "x${with_simd}" = "xno"; then
        if test "x${require_simd}" = "xyes"; then
          { { $as_echo "$as_me:$LINENO: error: SIMD support can't be enabled." >&5
$as_echo "$as_me: error: SIMD support can't be enabled." >&2;}
   { (exit 1); exit 1; }; }
        else
          { $as_echo "$as_me:$LINENO: WARNING: SIMD support can't be enabled.  Performance will suffer." >&5
$as_echo "$as_me: WARNING: SIMD support can't be enabled.  Performance will suffer." >&2;}
        fi
      fi
      ;;
    aarch64*)
      { $as_echo "$as_me:$LINENO: result: yes (arm64)" >&5
$as_echo "yes (arm64)" >&6; }
      { $as_echo "$as_me:$LINENO: checking if the assembler is GNU-compatible and can be used" >&5
$as_echo_n "checking if the assembler is GNU-compatible and can be used... " >&6; }
...
$as_echo "$as_me: WARNING: SIMD support can't be enabled.  Performance will suffer." >&2;}
      ...
      ;;
    mips*)
      { $as_echo "$as_me:$LINENO: result: yes (mips)" >&5
$as_echo "yes (mips)" >&6; }
      { $as_echo "$as_me:$LINENO: checking if the assembler is GNU-compatible and can be used" >&5
$as_echo_n "checking if the assembler is GNU-compatible and can be used... " >&6; }
...
$as_echo "$as_me: WARNING: SIMD support can't be enabled.  Performance will suffer." >&2;}
      ...
      ;;
    powerpc*)
      { $as_echo "$as_me:$LINENO: result: yes (powerpc)" >&5
$as_echo "yes (powerpc)" >&6; }
      simd_arch=powerpc
      ;;
    *)
      { $as_echo "$as_me:$LINENO: result: no (\"$host_cpu\")" >&5
$as_echo "no (\"$host_cpu\")" >&6; }
      with_simd=no;
      if test "x${require_simd}" = "xyes"; then
        { { $as_echo "$as_me:$LINENO: error: SIMD support not available for this CPU." >&5
$as_echo "$as_me: error: SIMD support not available for this CPU." >&2;}
   { (exit 1); exit 1; }; }
      else
        { $as_echo "$as_me:$LINENO: WARNING: SIMD support not available for this CPU.  Performance will suffer." >&5
...
if test -z "${HAVE_LIBPNG_TRUE}" && test -z "${HAVE_LIBPNG_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"HAVE_LIBPNG\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"HAVE_LIBPNG\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${VERSION_SCRIPT_TRUE}" && test -z "${VERSION_SCRIPT_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"VERSION_SCRIPT\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"VERSION_SCRIPT\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${WITH_ARITH_ENC_TRUE}" && test -z "${WITH_ARITH_ENC_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_ARITH_ENC\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_ARITH_ENC\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${WITH_ARITH_DEC_TRUE}" && test -z "${WITH_ARITH_DEC_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_ARITH_DEC\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_ARITH_DEC\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${WITH_ARITH_TRUE}" && test -z "${WITH_ARITH_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_ARITH\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_ARITH\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${WITH_12BIT_TRUE}" && test -z "${WITH_12BIT_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_12BIT\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_12BIT\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
...
if test -z "${WITH_SIMD_TRUE}" && test -z "${WITH_SIMD_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_SIMD\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_SIMD\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${WITH_SSE_FLOAT_DCT_TRUE}" && test -z "${WITH_SSE_FLOAT_DCT_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_SSE_FLOAT_DCT\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_SSE_FLOAT_DCT\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_I386_TRUE}" && test -z "${SIMD_I386_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_I386\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_I386\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_X86_64_TRUE}" && test -z "${SIMD_X86_64_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_X86_64\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_X86_64\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_ARM_TRUE}" && test -z "${SIMD_ARM_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_ARM\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_ARM\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_ARM_64_TRUE}" && test -z "${SIMD_ARM_64_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_ARM_64\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_ARM_64\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_MIPS_TRUE}" && test -z "${SIMD_MIPS_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_MIPS\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_MIPS\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
if test -z "${SIMD_POWERPC_TRUE}" && test -z "${SIMD_POWERPC_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"SIMD_POWERPC\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"SIMD_POWERPC\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
...
if test -z "${WITH_TURBOJPEG_TRUE}" && test -z "${WITH_TURBOJPEG_FALSE}"; then
  { { $as_echo "$as_me:$LINENO: error: conditional \"WITH_TURBOJPEG\" was never defined.
Usually this means the macro was only invoked conditionally." >&5
$as_echo "$as_me: error: conditional \"WITH_TURBOJPEG\" was never defined.
Usually this means the macro was only invoked conditionally." >&2;}
   { (exit 1); exit 1; }; }
fi
